...
const Cart_order = () => {
  ...
  if (localStorage.getItem("cart_info")) {
    var { address, email, name, phone } = JSON.parse(
  ...
  const cartTotalPrice =
    cart.cartTotal - couponPrice <= 0 ? 0 : cart.cartTotal - couponPrice;
      ...
      <div className="row">
        ...
        <div className="col-4">
          <div className="checkarea mt-5">
            ...
            <button
              className="next_page my-2 sweet_btn"
              onClick={() => {
                Swal.fire({
                  title: "確定要送出訂單?",
                  icon: "warning",
        ...
        <div className="col-8">
          <div className="form-check">
            <input
              ...
              id="flexCheckDefault"
              onChange={() => {
                setNumber(4901594368375209);
                setCardName("Arthur Wang");
                setExpiry("01/26");
                setCvc(617)    
              }}
            />
