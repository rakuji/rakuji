            ...
            <div key={i} className="nav col">
              <div className="col-6">
                ...
                <input
                  ...
                  id="recipesIngredients_Name"
                  name="recipesIngredients_Name"
                  defaultValue={recipesIngredients_Name}
                />
              </div>
              <div className="col-6">
                <label htmlFor="name" className="form-label">
                ...
                <input
                  type="text"
                  className="form-control"
                  id="RecipesIngredients_Quantity"
                  name="RecipesIngredients_Quantity"
                  defaultValue={RecipesIngredients_Quantity}
                />
              </div>
            </div>
          );
