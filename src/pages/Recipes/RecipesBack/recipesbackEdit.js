  ...
  const fetchNews = async () => {
    ...
    const response2 = await fetch(
      `${process.env.REACT_APP_API_URL}/recipes/recipesbackEdit/${id}`,
      {
        ...
        body: JSON.stringify({ RecipesBox_Time: data[0].RecipesBox_Time }),
      }
    );
                    ...
                    <form name="form1" method="put">
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="name"
                          name="name"
                          defaultValue={v.RecipesBox_Kcal}
                        ></input>
                        <div className="form-text"></div>
                      </div>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="name"
                          name="name"
                          defaultValue={v.RecipesBox_Time}
                        ></input>
                        <div className="form-text"></div>
                      </div>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="name"
                          name="name"
                          defaultValue={v.RecipesBox_SeveralCopies}
                        ></input>
                        <div className="form-text"></div>
                      </div>
                      <div className="mb-3">
