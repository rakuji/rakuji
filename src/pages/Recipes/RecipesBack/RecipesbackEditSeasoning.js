            ...
            <div key={i} className="nav col">
              <div className="col-6">
                ...
                <input
                  ...
                  id="RecipesSeasoning_Name"
                  name="RecipesSeasoning_Name"
                  defaultValue={RecipesSeasoning_Name}
                />
              </div>
              <div className="col-6">
                <label htmlFor="name" className="form-label">
                ...
                <input
                  type="text"
                  className="form-control"
                  id="RecipeSseasoning_Quantity"
                  name="RecipeSseasoning_Quantity"
                  defaultValue={RecipeSseasoning_Quantity}
                />
              </div>
            </div>
          );
