  ...
  return (
    <>
      ...
      <div className="bg">
        ...
        {/* 樂物語圖片 */}
        <section>
          <div className="row my justify-content-start">
            <div className="col-4 col-md-4 col-lg-2">
              <img
                src={require("./images/rakujiStory.png")}
                className="img-fluid my"
                alt="樂物語"
              />
            </div>
          </div>
          ...
          <div className="row my">
            <div className="col-6">
              <img src={require("./images/story-1.png")} className="img-fluid my about" alt="" />
            </div>
            <div className="col-6">
              <div className="row my">
        ...
        <section>
          ...
          <div className="row my">
            <div className="col-12">
              <img src={require("./images/style-1.png")} className="img-fluid my about" alt="style-1.png" />
            </div>
            <div className="col-12">
              <img src={require("./images/style-2.png")} className="img-fluid my about" alt="style-2.png" />
            </div>
          </div>
        </section>
        {/* 町尋路 */}
        <section>
          ...
          <div className="row my mapFrame">
      
            <div className="col-12 col-md-4 mapQuery">
              <select id="select1" className="form-select my" aria-label="Default select example">
                <option selected>請先選擇區域</option>
              </select>
              <select id="select2" className="form-select my" aria-label="Default select example">
